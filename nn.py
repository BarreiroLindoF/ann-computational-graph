...
class Linear:
    ...
    def __init__(self, in_features, out_features, bias=True):
        ...
        #######################################################################
        random_values = np.random.uniform(-np.sqrt(1 / self.in_features), np.sqrt(1 / self.in_features), self.in_features * self.out_features)
        self.W = Variable(random_values.reshape(self.out_features, self.in_features))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
        ...
        if self.bias:
            ...
            # Ton't forget to wrap the data into a Variable.
            #######################################################################
            random_values = np.random.uniform(-np.sqrt(1 / self.in_features), np.sqrt(1 / self.in_features), self.out_features)
            self.b = Variable(random_values.reshape(1, self.out_features))
            #######################################################################
            # --------------------------- END OF YOUR CODE ------------------------
            #######################################################################
