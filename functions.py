...
class Div(_Function):
    ...
    def _backward(self, grad):
        ...
        self.dy = grad * -(self.x.data / (self.y.data * self.y.data))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Tan(_Function):
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        self.dx = grad * (1 / (np.cos(self.x.data))**2)
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Sigmoid(_Function):
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        self.dx = grad * (self.result * (1 - self.result))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Tanh(_Function):
    ...
    def __init__(self, x):
        ...
        # The notbook provide you the formulas for this operation.
        #######################################################################
        self.result = (np.exp(x.data) - np.exp(-x.data)) / (np.exp(x.data) + np.exp(-x.data))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
